...
◆ [key_event] 独自キーイベント登録
    ...
    element   こちらはCSSないしjQueryを理解している人向けです。
              ...
              デフォルト値はbody要素ですが、もしもバグが発生した場合は#tyrano_base等別の要素の指定を試みてください
              ※windowオブジェクトないしdocumentオブジェクトの指定はできません
...
2021/04/17 $.key_event.checkメソッド追加
2021/04/16 window / documentの指定を禁止
2021/04/14 min化
2021/04/04 remake
